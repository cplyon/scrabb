...
class GameTest(unittest.TestCase):
    ...
    def test_is_adjacent_above_left(self):
        game = Game()
        game.board[Board.MIDDLE[0]][Board.MIDDLE[1]] = Tile('A', 1)
        game.board[Board.MIDDLE[0]+1][Board.MIDDLE[1]] = Tile('B', 1)
        game.board[Board.MIDDLE[0]][Board.MIDDLE[1]+1] = Tile('C', 1)
    ...
    def test_is_adjacent_above_right(self):
        game = Game()
        game.board[Board.MIDDLE[0]][Board.MIDDLE[1]] = Tile('A', 1)
        game.board[Board.MIDDLE[0]+1][Board.MIDDLE[1]+1] = Tile('B', 1)
        game.board[Board.MIDDLE[0]][Board.MIDDLE[1]+1] = Tile('C', 1)
        direction = game.is_adjacent((Board.MIDDLE[0]+1, Board.MIDDLE[1]))
        self.assertEqual(direction,
    ...
    def test_is_adjacent_left_right(self):
        game = Game()
        game.board[Board.MIDDLE[0]][Board.MIDDLE[1]] = Tile('A', 1)
        game.board[Board.MIDDLE[0]][Board.MIDDLE[1]+2] = Tile('B', 1)
        direction = game.is_adjacent((Board.MIDDLE[0], Board.MIDDLE[1]+1))
        self.assertEqual(direction,
    ...
    def test_is_adjacent_above_below(self):
        game = Game()
        game.board[Board.MIDDLE[0]][Board.MIDDLE[1]] = Tile('A', 1)
        game.board[Board.MIDDLE[0]+2][Board.MIDDLE[1]] = Tile('B', 1)
        direction = game.is_adjacent((Board.MIDDLE[0]+1, Board.MIDDLE[1]))
        self.assertEqual(direction,
    ...
    def test_is_adjacent_above_below_left_right(self):
        ...
        game.board[Board.MIDDLE[0]][Board.MIDDLE[1]] = Tile('A', 1)
        game.board[Board.MIDDLE[0]+2][Board.MIDDLE[1]] = Tile('B', 1)
        game.board[Board.MIDDLE[0]+1][Board.MIDDLE[1]+1] = Tile('A', 1)
        game.board[Board.MIDDLE[0]+1][Board.MIDDLE[1]-1] = Tile('B', 1)
        direction = game.is_adjacent((Board.MIDDLE[0]+1, Board.MIDDLE[1]))
        self.assertEqual(direction,
                         AdjacentDirection.LEFT | AdjacentDirection.RIGHT |
    ...
    def test_get_contiguous_left(self):
        game = Game()
        game.board[Board.MIDDLE[0]][Board.MIDDLE[1]-1] = Tile('L', 1)
        game.board[Board.MIDDLE[0]][Board.MIDDLE[1]-2] = Tile('L', 1)
        game.board[Board.MIDDLE[0]][Board.MIDDLE[1]-3] = Tile('L', 1)
        game.board[Board.MIDDLE[0]][Board.MIDDLE[1]-5] = Tile('L', 1)
    ...
    def test_get_contiguous_right(self):
        game = Game()
        game.board[Board.MIDDLE[0]][Board.MIDDLE[1]+1] = Tile('R', 1)
        game.board[Board.MIDDLE[0]][Board.MIDDLE[1]+2] = Tile('R', 1)
        game.board[Board.MIDDLE[0]][Board.MIDDLE[1]+3] = Tile('R', 1)
        game.board[Board.MIDDLE[0]][Board.MIDDLE[1]+5] = Tile('R', 1)
    ...
    def test_get_contiguous_above(self):
        game = Game()
        game.board[Board.MIDDLE[0]-1][Board.MIDDLE[1]] = Tile('A', 1)
        game.board[Board.MIDDLE[0]-2][Board.MIDDLE[1]] = Tile('A', 1)
        game.board[Board.MIDDLE[0]-3][Board.MIDDLE[1]] = Tile('A', 1)
        game.board[Board.MIDDLE[0]-5][Board.MIDDLE[1]] = Tile('A', 1)
    ...
    def test_get_contiguous_below(self):
        ...
        game.board[Board.MIDDLE[0]+1][Board.MIDDLE[1]] = Tile('B', 1)
        game.board[Board.MIDDLE[0]+2][Board.MIDDLE[1]] = Tile('B', 1)
        game.board[Board.MIDDLE[0]+3][Board.MIDDLE[1]] = Tile('B', 1)
        game.board[Board.MIDDLE[0]+5][Board.MIDDLE[1]] = Tile('B', 1)
    ...
    def test_find_words_horizontal_parallel(self):
        game = Game()
        game.board[Board.MIDDLE[0]][Board.MIDDLE[1]] = Tile('R', 1)
        game.board[Board.MIDDLE[0]][Board.MIDDLE[1]+1] = Tile('R', 1)
        game.board[Board.MIDDLE[0]][Board.MIDDLE[1]+2] = Tile('R', 1)
        game.board.is_empty = False
        words = game.find_words(Orientation.HORIZONTAL,
    ...
    def test_find_words_vertical_parallel(self):
        game = Game()
        game.board[Board.MIDDLE[0]][Board.MIDDLE[1]] = Tile('B', 1)
        game.board[Board.MIDDLE[0]+1][Board.MIDDLE[1]] = Tile('B', 1)
        game.board.is_empty = False
        words = game.find_words(Orientation.VERTICAL,
                                [(Board.MIDDLE[0], Board.MIDDLE[1]+1,
